...
def Connect2CAD():
    ...
    print("\n--- Summary of Extracted MLeader Texts ---")
    # for text in units: 
    #     print(text)
    # for text in ter_li: 
    #     print(text)
    print( f"{len(ter_li)} Terminals found.")
    update_status("ODN check complete ✅")
    log("ODN check completed successfully.")
...
if __name__ == "__main__":
    try:
        ...
        # search_id = "1203/@019"
        # result = ter_li.get(search_id)
        # if result:
        #     print(f"Details for Terminal ID {search_id}: {result}")
        # else:
        #     print(f"Terminal ID {search_id} not found.")
        # js=pd.DataFrame()
        # odn=pd.DataFrame()
